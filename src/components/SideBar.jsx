      ...
      <Col id='menu' md={2} className='col-2 black-bg'>
        <div>
          ...
          <ListGroup id='menuOl' className='text-left'>
            <ListGroupItem>
              <Link to='/'>
                <i className='fa fa-home pr-2'></i>Home
              </Link>
            </ListGroupItem>
            <ListGroupItem className='border-left'>
              <i className='fa fa-search pr-2'></i>Search
            </ListGroupItem>
            <ListGroupItem>
              <i className='fa fa-bookmark pr-2'></i>Your Library
            </ListGroupItem>
          </ListGroup>
        </div>
        <div id='menu2'>
          <p>
            <i className=' ml-2 fa fa-download pr-2'></i>Install App
          </p>
          <hr></hr>
